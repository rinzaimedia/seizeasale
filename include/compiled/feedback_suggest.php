    ...
    <div id="content" class="help">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="sect">
                                    <p class="notice">Please leave your message.</p>
                    <form id="feedback-user-form" method="post" action="/feedback/suggest.php" class="validator">
                        ...
                        <div class="field email">
                            <label for="feedback-email-address">Contact info</label>
                            ...
                            <span class="hint">Please leave your MSN,email,or other contact info</span>
                        </div>
