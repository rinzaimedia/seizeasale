		...
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>Consultations</h2>
                    <ul class="filter">
						<li><form action="/manage/misc/ask.php" method="get">item：<input type="text" class="h-input" name="title" value="<?php echo htmlspecialchars($title); ?>" >&nbsp;<input type="submit" value="筛选" class="formbutton"  style="padding:1px 6px;"/><form></li>
					</ul>
				</div>
                <div class="sect">
					<table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
					<tr><th width="260">item</th><th width="60">Consultant</th><th width="200">咨询</th><th width="200">答复</th><th width="120">操作</th></tr>
