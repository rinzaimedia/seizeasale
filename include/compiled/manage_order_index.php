            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td class="op" nowrap><?php if($one['state']=='pay'){?><a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">Info</a><?php } else if($one['state']=='unpay') { ?><a href="/ajax/manage.php?action=ordercash&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="this order pay by cash?">cash</a><?php }?></td>
					</tr>
					<?php }}?>
