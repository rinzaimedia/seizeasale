	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>Edit merchant</h2><b style="margin-left:20px;font-size:16px;">(<?php echo $partner['title']; ?>)</b></div>
                <div class="sect">
					...
					<input type="hidden" name="id" value="<?php echo $partner['id']; ?>" />
                        ...
                        <div class="field password">
                            ...
                            <span class="hint">if don't want to change Password,please keep blank</span>
                        </div>
