        ...
        <div class="clear box">
            ...
            <div class="box-content">
                ...
                <div class="sect">
                    <form method="post">
					<!-- Alipay -->
						<div class="wholetip clear"><h3>1. Paypal</h3></div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" size="30" name="paypal[sec]" class="f-input" value="<?php echo $INI['paypal']['sec']; ?>"/>
                        </div>
                        <div class="field">
                            <label>Paypal emailbox</label>
                            <input type="text" size="30" name="paypal[acc]" class="f-input" value="<?php echo $INI['paypal']['acc']; ?>"/>
                        </div>
                        <!-- Alipay -->
						<div class="wholetip clear"><h3>2. alipay</h3></div>
                        <div class="field">
                            <label>Merchant ID number </label>
