    ...
    <div id="deal-buy" class="box">
        ...
        <div class="box-content">
			...
			<div class="field mobile">
				...
				<input type="text" size="30" name="mobile" id="settings-mobile" class="f-input" value="<?php echo $login_user['mobile']; ?>" datatype="mobile" maxLength="12" />
				<span class="hint">Mobile number is the contact way</span>
			</div>
			<div class="field mobile">
				<label>Zip code</label>
				<input type="text" size="30" name="zipcode" id="settings-mobile" class="f-input" value="<?php echo $login_user['zipcode']; ?>" datatype="zip" maxLength="6" />
			</div>
			<div class="field username">
				<label>Address</label>
